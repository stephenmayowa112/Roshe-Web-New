    ...
    <main className="w-full bg-white flex flex-col items-center flex-grow justify-center py-20">
      ...
      <section className="w-full max-w-7xl mx-auto relative h-[400px] overflow-hidden flex items-center bg-yellow-400" aria-label="Shop Banner">
        ...
        <div className="relative z-10 w-full max-w-xl px-10 md:px-16 text-left">
          ...
          <button className="bg-white text-black hover:bg-gray-100 px-8 py-3 rounded-full font-semibold text-sm uppercase tracking-wide transition-colors shadow-sm focus:outline-none focus:ring-4 focus:ring-black" aria-disabled="true">
            Shop now
          </button>
        </div>
      </section>
