  ...
  return (
    <div className="w-full bg-white flex flex-col items-center">
      ...
      <section className="w-full max-w-7xl mx-auto relative h-[40vh] md:h-[50vh] flex items-end justify-center pb-12 bg-gray-200 overflow-hidden">
        <img src="/images/seasonlings-hero.jpg" alt="Seasonlings Hero" className="absolute inset-0 w-full h-full object-cover object-top" />
      ...
      <section className="w-full max-w-5xl mx-auto px-4 py-20 flex flex-col md:flex-row gap-12 md:gap-20">
        <div className="w-full md:w-[400px] flex-shrink-0 bg-gray-800 p-8 rounded shadow-lg flex items-center justify-center">
          <img src="/images/seasonlings-poster.jpg" alt="Seasonlings Poster" className="w-full h-auto" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex flex-col gap-4">
            <div className="aspect-video relative cursor-pointer group bg-gray-200 shadow-md">
              <img src="/images/seasonlings-teaser.jpg" alt="Teaser" className="absolute inset-0 w-full h-full object-cover group-hover:opacity-90 transition-opacity" />
          ...
          <div className="flex flex-col gap-4">
            <div className="aspect-video relative cursor-pointer group bg-gray-200 shadow-md overflow-hidden">
              <img src="/images/seasonlings-gallery.jpg" alt="Gallery" className="absolute inset-0 w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-500" />
