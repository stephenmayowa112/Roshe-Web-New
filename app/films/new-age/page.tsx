  ...
  return (
    <div className="w-full bg-white flex flex-col items-center">
      ...
      <section className="w-full max-w-7xl mx-auto relative h-[40vh] md:h-[50vh] bg-gray-200 overflow-hidden">
        <img src="/images/new-age-hero.jpg" alt="New Age Hero" className="absolute inset-0 w-full h-full object-cover" />
      </section>

      {/* Details Section */}
      <section className="w-full max-w-5xl mx-auto px-4 py-20 flex flex-col md:flex-row gap-12 md:gap-20">
        <div className="w-full md:w-[400px] flex-shrink-0">
          <img src="/images/new-age-poster.jpg" alt="New Age Poster" className="w-full h-auto shadow-lg" />
        </div>
      ...
      <section className="w-full max-w-6xl mx-auto px-4 pb-20">
        <div className="flex flex-col gap-4">
          <div className="aspect-[21/9] relative cursor-pointer group bg-gray-200 overflow-hidden shadow-md">
            <img src="/images/new-age-gallery.jpg" alt="Gallery" className="absolute inset-0 w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-500" />
