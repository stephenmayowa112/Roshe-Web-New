  ...
  return (
    <div className="w-full bg-white flex flex-col items-center pb-24">
      ...
      <section className="w-full max-w-7xl mx-auto relative h-[35vh] md:h-[45vh] flex items-center justify-center bg-gray-200 overflow-hidden mb-16">
        <Image src="/images/remember-me-hero.png" alt="licensing-hero.png" fill className="object-cover" referrerPolicy="no-referrer" />
      ...
      <section className="w-full max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
        ...
        <div className="flex items-start justify-center md:justify-end">
          <div className="w-full max-w-[400px] aspect-[3/4] relative rounded-3xl shadow-xl overflow-hidden">
            <Image src="/images/remember-me-poster.png" alt="licensing-poster.png" fill className="object-cover" referrerPolicy="no-referrer" />
          </div>
        </div>
      </section>
    </div>
